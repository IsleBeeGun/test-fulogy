...
export class Header extends React.Component {
  constructor(props) {
    super(props);
    this.state = { icon: "fas fa-bars" };
    this.handleClick = this.handleClick.bind(this);
  }
  handleClick() {
    console.log(this.state.icon === "fas fa-bars");
    this.props.toggleMenu();
    if (this.state.icon === "fas fa-bars") {
      ...
      <header className="header-container">
        <div className="logo-container">
          <svg
            className="logo"
            id="LogoSvgHeader"
            viewBox="-4.875 18.75 82.125 34.375"
            enableBackground="new -4.875 18.75 82.125 34.375"
          >
            <path
              fill="#FFFFFF"
            ...
            <polygon
              fill="#FFFFFF"
              points="69.9,45.8 69.9,45.8 69.9,45.8 "
            ></polygon>
            <polygon
              fill="#FFFFFF"
              points="65.1,41.5 65.1,41.5 65.1,41.5 "
            ></polygon>
            <polygon
              fill="#FFFFFF"
              points="56.3,41.5 56.3,41.5 56.3,41.5 "
            ></polygon>
            <polygon
              fill="#FFFFFF"
              points="57.3,40.7 57.3,40.7 57.3,40.7 "
            ></polygon>
            <path
              fill="#FFFFFF"
            ...
            <polygon
              fill="#FFFFFF"
              points="51.5,40.6 51.5,40.6 51.5,40.6 "
            ></polygon>
            <path
              fill="#FFFFFF"
